...
class AuthController extends GetxController implements GetxService {
  ...
  /// Wipes ALL local user data from SharedPreferences.
  /// Called during account deletion.
  Future<bool> wipeAllUserLocalData() async {
    return await authServiceInterface.wipeAllUserLocalData();
  }
  ...
  Future<void> socialLogout() async {
    try {
      ...
      if (kDebugMode) print('GoogleSignIn disconnect error: $e');
    }
    try {
      await FacebookAuth.instance.logOut();
    } catch (e) {
      if (kDebugMode) print('FacebookAuth logOut error: $e');
    }
  }
