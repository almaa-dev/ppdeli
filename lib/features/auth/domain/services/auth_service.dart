...
class AuthService implements AuthServiceInterface{
  ...
  Future<bool> clearSharedData({bool removeToken = true, bool createGuestSession = true}) async {
    return await authRepositoryInterface.clearSharedData(removeToken: removeToken, createGuestSession: createGuestSession);
  }

  @override
  Future<bool> wipeAllUserLocalData() async {
    return await authRepositoryInterface.wipeAllUserLocalData();
  }
