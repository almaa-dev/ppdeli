...
import 'package:pickles_and_pies/features/home/widgets/filter_view.dart';
import 'package:pickles_and_pies/features/home/widgets/store_filter_button_widget.dart';
            ...
            child: ResponsiveHelper.isDesktop(context) ? Row(children: [
              Expanded(
                child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  Text(
                    Get.find<SplashController>().configModel!.moduleConfig!.module!.showRestaurantText! ? 'all_foods'.tr : 'stores'.tr,
