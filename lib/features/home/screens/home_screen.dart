...
// import 'package:pickles_and_pies/features/home/widgets/all_store_filter_widget.dart';
import 'package:pickles_and_pies/features/home/widgets/cashback_logo_widget.dart';
import 'package:pickles_and_pies/features/home/widgets/cashback_dialog_widget.dart';
import 'package:pickles_and_pies/features/home/widgets/refer_bottom_sheet_widget.dart';
...
import 'package:pickles_and_pies/features/ride_share_module/ride_home/screens/biding_list_screen.dart';
import 'package:pickles_and_pies/features/ride_share_module/ride_home/screens/ride_home_screen.dart';
...
import 'package:pickles_and_pies/features/home/screens/modules/food_home_screen.dart';
import 'package:pickles_and_pies/features/home/screens/modules/grocery_home_screen.dart';
import 'package:pickles_and_pies/features/home/screens/modules/pharmacy_home_screen.dart';
import 'package:pickles_and_pies/features/home/screens/modules/shop_home_screen.dart';
...
import 'package:pickles_and_pies/features/rental_module/home/screens/taxi_home_screen.dart';
...
import 'package:pickles_and_pies/common/widgets/paginated_list_view.dart';
import 'package:pickles_and_pies/common/widgets/web_menu_bar.dart';
import 'package:pickles_and_pies/features/home/screens/web_new_home_screen.dart';
import 'package:flutter/material.dart';
import 'package:get/get.dart';
import 'package:pickles_and_pies/features/home/widgets/module_view.dart';
            ...
            child: RefreshIndicator(
              ...
              child: ResponsiveHelper.isDesktop(context) ? WebNewHomeScreen(
                ...
                slivers: [
                  ...
                  SliverToBoxAdapter(child: !showMobileModule && !isTaxi && !isRide ? Center(child: GetBuilder<ItemController>(builder: (itemController) {
                    return Padding(
                      padding: EdgeInsets.only(bottom: ResponsiveHelper.isDesktop(context) ? 0 : 100),
                      child: PaginatedListView(
                        scrollController: _scrollController,
                        totalSize: itemController.popularItemList?.length,
                        offset: null,
                        onPaginate: (int? offset) async {},
                        gridColumns: ResponsiveHelper.isDesktop(context) ? 4 : 1,
                        itemView: ItemsView(
                          isStore: false,
                          items: itemController.popularItemList,
                          stores: null,
                          noDataText: 'no_item_available'.tr,
                          padding: EdgeInsets.symmetric(
