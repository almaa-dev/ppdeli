...
class Store {
  ...
  Store.fromJson(Map<String, dynamic> json) {
    ...
    latitude = _coerceCoordinate(json['latitude']);
    longitude = _coerceCoordinate(json['longitude']);
    ...
    featured = rawFeatured is num
        ? rawFeatured.toInt()
        : (rawFeatured == null ? 0 : int.parse(rawFeatured.toString()));
    zoneId = json['zone_id'];
...
class Refund {
  ...
  String? _coerceCoordinate(dynamic value) {
