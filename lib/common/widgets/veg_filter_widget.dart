...
class VegFilterWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return (AppConstants.showFoodType && Get.find<SplashController>().configModel!.moduleConfig!.module!.vegNonVeg! && Get.find<SplashController>().configModel!.toggleVegNonVeg!) ? Padding(
